...
var j=echarts.init(document.getElementById("echart_pie_fundlevel"),a);j.setOption({title:{text:"Project Distribution",subtext:"Across Funding Levels"},color:['#4ca0c6','#6e7074', '#546570', '#c4ccd3'], tooltip:{trigger:"item",formatter:"{a} <br/>{b} : {c} ({d}%)"},legend:{x:"center",y:"bottom",data:["$10k and Below","$10k - $20k","$20k - $30k","Above $30k"]},toolbox:{show:!0,feature:{magicType:{show:!0,type:["pie","funnel"],option:{funnel:{x:"25%",width:"50%",funnelAlign:"left",max:1548}}},restore:{show:!0,title:"Restore"},saveAsImage:{show:!0,title:"Save Image"}}},calculable:!0,series:[{name:"Number of Projects",type:"pie",radius:[50,140],center:["54%",178],x:"45%",max:40, data:[{value:less10k, name:"$10k and Below"},{value:less20k,name:"$10k - $20k"},{value:less30k,name:"$20k - $30k"},{value:above30k,name:"Above $30k"}]}]});var k={normal:{label:{show:!1},labelLine:{show:!1}}},l={normal:{color:"rgba(0,0,0,0)",label:{show:!1},labelLine:{show:!1}},emphasis:{color:"rgba(0,0,0,0)"}}
...
var j2=echarts.init(document.getElementById("echart_pie_fundlevel2"),a);j2.setOption({title:{text:"Funds Distribution",subtext:"Across Funding Levels"},color:[  "#4ca0c6",'#bda29a','#6e7074', '#546570', '#c4ccd3'],tooltip:{trigger:"item",formatter:"{a} <br/>{b} : {c} ({d}%)"},legend:{x:"center",y:"bottom",data:["$10k and Below","$10k - $20k","$20k - $30k","Above $30k"]},toolbox:{show:!0,feature:{magicType:{show:!0,type:["pie","funnel"],option:{funnel:{x:"25%",width:"50%",funnelAlign:"left",max:1548}}},restore:{show:!0,title:"Restore"},saveAsImage:{show:!0,title:"Save Image"}}},calculable:!0,series:[{name:"Cumulative Amount USD",type:"pie",radius:"75%",center:["50%","48%"],data:[{value:less10k, name:"$10k and Below"},{value:less20k,name:"$10k - $20k"},{value:less30k,name:"$20k - $30k"},{value:above30k,name:"Above $30k"}]}]});var k={normal:{label:{show:!1},labelLine:{show:!1}}},l={normal:{color:"rgba(0,0,0,0)",label:{show:!1},labelLine:{show:!1}},emphasis:{color:"rgba(0,0,0,0)"}}
...
var n=echarts.init(document.getElementById("rladies_world_map"),a);n.setOption({title:{text:"",subtext:"",x:"center",y:"top"},tooltip:{trigger:"item",formatter:function(a){var b=(a.value+"").split(".");return b=b[0].replace(/(\d{1,3})(?=(?:\d{3})+(?!\d))/g,"$1,"),a.seriesName+"<br/>"+a.name+" : "+b}},toolbox:{show:!0,orient:"vertical",x:"right",y:"center",feature:{mark:{show:!0},dataView:{show:!0,title:"Text View",lang:["Text View","Close","Refresh"],readOnly:!1},restore:{show:!0,title:"Restore"},saveAsImage:{show:!0,title:"Save Image"}}},dataRange:{min:0,max:55,text:["High","Low"],realtime:!1,calculable:!0,color:["#920076","#d036b2","#ff94e7","#FFFFFF"]},series:[{name:"R Ladies Groups ",type:"map",mapType:"world",roam:!0,mapLocation:{y:60},itemStyle:{emphasis:{label:{show:!0}}}, data:JSON.parse(dat2)
}]
})
}); // d3.csv call
}
...
var f=echarts.init(document.getElementById("cumulative_chart"),a);f.setOption({title:{text:"",subtext:""},tooltip:{trigger:"axis"},legend:{x:220,y:40,data:["Count of Chapters"]},toolbox:{show:!0,feature:{magicType:{show:!0,title:{line:"Line",bar:"Bar"},type:["line","bar"]},restore:{show:!0,title:"Restore"},saveAsImage:{show:!0,title:"Save Image"}}},calculable:!0,xAxis:[{type:"category",boundaryGap:!1,data: dates}],yAxis:[{type:"value"}],series:[{name:"Count of Chapters",type:"line",smooth:!1,itemStyle:{normal:{areaStyle:{type:"default"}}},data:counts}]})
